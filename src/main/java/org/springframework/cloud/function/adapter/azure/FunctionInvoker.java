...
public class FunctionInvoker<I, O> {
    ...
    public O handleRequest(ExecutionContext context) {
        return this.handleRequest(null, context, null);
    }
    ...
    public void handleOutput(I input, OutputBinding<O> binding,
        ...
        O result = handleRequest(input, context, null);
        binding.setValue(result);
    }

    @SuppressWarnings({ "unchecked", "rawtypes" })
    public O handleRequest(I input, ExecutionContext executionContext, HttpRequestMessage<?> request) {
        ...
        CurrentTraceContext currentTraceContext = APPLICATION_CONTEXT.getBean(CurrentTraceContext.class);
        HttpServerHandler httpServerHandler = APPLICATION_CONTEXT.getBean(HttpServerHandler.class);
        Span span = httpServerHandler.handleReceive(new AzureHttpServerRequest(request));
        ...
        try {
            ...
            httpServerHandler.handleSend(new HttpServerResponse() {
                /* TODO */
                @Override
    ...
    static class AzureHttpServerRequest implements HttpServerRequest {
        private final HttpRequestMessage<?> delegate;

        private final Map<String, String> headers;

        public AzureHttpServerRequest(HttpRequestMessage<?> delegate) {
